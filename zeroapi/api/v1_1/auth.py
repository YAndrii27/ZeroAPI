...
@auth_router.post("/login", tags=["auth"], deprecated=True)
async def login(request: LoginRequest):
    """Verify auth data and returns token which can be used
...
@auth_router.post("/register", tags=["auth"], deprecated=True)
